...
function loadLevels() {
    ...
    level_one.addItem(items.clementine, false, 'data/jogo/certoErrado/errado.png', 'Clementina');
    ...
    level_three.addItem(items.orange, false, 'data/jogo/certoErrado/errado.png', 'Laranja');
